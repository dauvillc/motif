...
from motif.models.acn import AdaptiveConditionalNormalization
...
from motif.models.motif.self_full_att import SeparateAttention
...
class MultisourceGeneralBackbone(nn.Module):
    ...
    2. Individual self-att attention;
    ...
    def __init__(
        ...
        for block_idx in range(n_blocks):
            block = nn.ModuleList(
                [
                    AdaptiveConditionalNormalization(
