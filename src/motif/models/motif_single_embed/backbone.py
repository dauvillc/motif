...
from motif.models.motif_single_embed.cross_attention import (
    MultisourcesWindowedCrossAttention,
)
from motif.models.motif_single_embed.self_attention import (
    SeparateWindowedValuesCoordinatesAttention,
)
from motif.models.motif_single_embed.small_layers import FeedForward
